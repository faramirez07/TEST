...
namespace Test.Controllers
{
    public class PolicyClientController : Controller
    {
        public ActionResult Index()
        {
            ...
            var request = clientHttp.GetAsync("api/PolicyClient").Result;
        ...
        [HttpPost]
        public ActionResult New(PolicyClientM policyClient)
        {
            HttpClient clientHttp = new HttpClient();
            clientHttp.BaseAddress = new Uri("https://localhost:44324/");

            var request = clientHttp.PostAsync("api/PolicyClient", policyClient, new JsonMediaTypeFormatter()).Result;
        ...
        public ActionResult Update(int id)
        {
            ...
            var request = clientHttp.GetAsync("api/PolicyClient?id=" + id).Result;
        ...
        public ActionResult Delete(int id)
        {
            ...
            var request = clientHttp.DeleteAsync("api/PolicyClient?id=" + id).Result;
